...
impl State {
    async fn new(window: Window) -> Self {
        ...
        // adapter is a handle to a physical GPU
        ...
        // device is a handle to a logical GPU
        ...
        // The surface configuration describes how the swap chain should function.
        ...
        let pixel_art = pixel_art::PixelArt::new(&config, &device, &texture_1_view);
    ...
    pub fn resize(&mut self, new_size: winit::dpi::PhysicalSize<u32>) {
        if new_size.width > 0 && new_size.height > 0 {
            ...
            self.redo_texture();
            self.pixel_art.resize(&self.device, &self.texture_1_view);
        }
    }
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        ...
        self.pixel_art.render(&view, &mut encoder);
    ...
    fn render_scene(&self, view: &wgpu::TextureView, encoder: &mut wgpu::CommandEncoder) {
