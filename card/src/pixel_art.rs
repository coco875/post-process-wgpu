...
impl PixelArt {
    pub fn new(
        ...
        let bind_group_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            ...
            label: Some("pixel_texture_bind_group_layout"),
        });
        ...
        let diffuse_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            label: Some("pixel_texture_bind_group"),
        });

        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("pixel Shader"),
            source: wgpu::ShaderSource::Wgsl(include_str!("pixel_art.wgsl").into()),
        });
    ...
    /// This is useful when texture are recreated (e.g. on resize).
